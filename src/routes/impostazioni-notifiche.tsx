...
export const Route = createFileRoute("/impostazioni-notifiche")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://gestionepuntoblu.lovable.app/impostazioni-notifiche" },
    ...
    links: [{ rel: "canonical", href: "https://gestionepuntoblu.lovable.app/impostazioni-notifiche" }],
  }),
