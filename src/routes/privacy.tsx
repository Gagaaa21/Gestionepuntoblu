...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://your-domain.example/privacy" },
    ...
    links: [{ rel: "canonical", href: "https://your-domain.example/privacy" }],
  }),
        ...
        <Card className="section-card">
          ...
          <CardContent className="space-y-2 text-sm leading-relaxed">
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>L'infrastruttura di hosting è fornita da Vercel e il database da Supabase. Comunicazioni client-server in HTTPS.</li>
            </ul>
          </CardContent>
        </Card>
