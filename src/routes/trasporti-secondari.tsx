...
export const Route = createFileRoute("/trasporti-secondari")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://gestionepuntoblu.lovable.app/trasporti-secondari" },
    ...
    links: [{ rel: "canonical", href: "https://gestionepuntoblu.lovable.app/trasporti-secondari" }],
  }),
  component: Page,
});
